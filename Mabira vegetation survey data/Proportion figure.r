...
coloury=c("grey15","grey45","grey75")
x11();par(mfrow=c(2,3), mar=c(4,3,1,1), mgp=c(2,0.8,0), cex.main=1, pin=c(1.5,2)) 
barplot(Tsums, ylim=c(0,1), xlab="Age class", ylab="Proportion of occurrences",main="Trees >10cm dbh", col=coloury)
barplot(Ssums, ylim=c(0,1), xlab="Age class", ylab="Proportion of occurrences", main="Shrubs and saplings <10cm dbh", col=coloury)
plot(Ssums,type="n", axes=F, xlab="",ylab="")
legend("topleft",legend=c("Open habitat affiliation", "Forest specialist", "Forest generalist"), fill=c("grey75","grey45","grey15"))
barplot(Hsums, ylim=c(0,1), xlab="Age class", ylab="Proportion of occurrences", main="Herbs", col=coloury)
barplot(Fsums, ylim=c(0,1), xlab="Age class", ylab="Proportion of occurrences", main="Ferns", col=coloury)

...
setwd("C:\\Users\\Rhoda Nankabirwa\\Documents\\Thesis\\KampalaFragments\\")
#import data
...
#how many species were there at each site?
...
treedca
#step2 - as it's a unimodal model, start with the simpler one and see if there is a tick or horseshoe shape. If there is, you want a DCA
treeca<-cca(fattreetable[,2:193])
plot(treeca)
#We already have the DCA from above so don't need it again
plot(treedca)

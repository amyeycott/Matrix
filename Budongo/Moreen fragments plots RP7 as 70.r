...
#Here are the spotplots in threes with range bars (some in colour, some not) for ind transects. They run till line 77-ish. Figure 2 is about line 177
...
errbar(sums$V1, sums$rarefied, maxes$rarefied, mins$rarefied, ylab="Rarefied species richness", ylim=c(0,45), xlim=c(0,25), col= c("gray27","red","gray57","gray87")[as.factor(sums$Matrix.type)],pch=16, cex=1.5, xlab="Canopy Openness (%)")
 ...
 # Two compound figures with greyscale error bars (first goes abun-rare, second goes FF-INGR. No legend - can do in figure legend text)
 x11(); par(mar=c(2,5,3,0.1),oma=c(0,0,0,0), mfrow=c(2,3), ann=F, mgp=c(3,0.4,0), tcl=-0.4)
errbar(sums$Distance, sums$abun, maxes$totalbirds, mins$totalbirds, ylim=c(0,300), xlim=c(0,15), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5,errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,330,"Distance from forest (km)", adj = c(0,0), cex=1.3, xpd=T)
text(-4,100,"Abundance", adj = c(0,0), cex=1.3, xpd=T, srt=90)
errbar(sums$FragmentSize, sums$abun, maxes$totalbirds, mins$totalbirds, ylim=c(0,300), xlim=c(0,500), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,330,"Fragment size (ha)", adj = c(0,0), cex=1.3, xpd=T)
errbar(sums$V1, sums$abun, maxes$totalbirds, mins$totalbirds, ylim=c(0,300), xlim=c(0,25), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, xpd=NA,errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,330,"Canopy openness (%)", adj = c(0,0), cex=1.3, xpd=T)

errbar(sums$Distance, sums$rarefied, maxes$rarefied, mins$rarefied,  ylim=c(0,20), xlim=c(0,15), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(-4,5,"Rarefied species richness", adj = c(0,0), cex=1.3, xpd=T, srt=90)
errbar(sums$FragmentSize, sums$rarefied, maxes$rarefied, mins$rarefied,  ylim=c(0,20), xlim=c(0,500), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)]) 
errbar(sums$V1, sums$rarefied, maxes$rarefied, mins$rarefied, ylim=c(0,20), xlim=c(0,25), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15),  cex=1.5, xpd=NA, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])

 savePlot("3x2 abunrich RP7_70.emf", type="emf")
 savePlot("3x2 abunrich RP7_70.eps", type="eps")
 savePlot("3x2 abunrich RP7_70.pdf", type="pdf")
...
text(0,1.1,"Fragment size (ha)", adj = c(0,0), cex=1.3, xpd=T)
...
#by prop spp - here and the stacked barplots are the only places I have done this.
 x11(); par(mar=c(2,5,3,0.1),oma=c(0,0,0,0), mfrow=c(2,3), ann=F, mgp=c(3,0.4,0), tcl=-0.4)
errbar(sums$Distance,(forests.guilds.byspp$FF/sums$spprich) , maxes.byspp$FFprop, mins.byspp$FFprop,ylim=c(0,1), xlim=c(0,15), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,1.1,"Distance from forest (km)", adj = c(0,0), cex=1.3, xpd=T)
text(-4,0.2,"Proportion forest specialist species", adj = c(0,0), cex=1.3, xpd=T, srt=90)  
errbar(sums$FragmentSize,(forests.guilds.byspp$FF/sums$spprich) , maxes.byspp$FFprop, mins.byspp$FFprop,ylim=c(0,1), xlim=c(0,500), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,1.1,"Fragment size (ha)", adj = c(0,0), cex=1.3, xpd=T)
errbar(sums$V1,(forests.guilds.byspp$FF/sums$spprich) , maxes.byspp$FFprop, mins.byspp$FFprop, ylim=c(0,1), xlim=c(0,25), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
text(0,1.1,"Canopy openness (%)", adj = c(0,0), cex=1.3, xpd=T)

errbar(sums$Distance,(forests.guilds.byspp$INGR/sums$spprich) , maxes.byspp$INGRprop, mins.byspp$INGRprop, ylim=c(0,0.4), xlim=c(0,15), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)]) 
text(-4,0,"Proportion ground-dwelling insectivore species", adj = c(0,0), cex=1.3, xpd=T, srt=90) 
errbar(sums$FragmentSize,(forests.guilds.byspp$INGR/sums$spprich) , maxes.byspp$INGRprop, mins.byspp$INGRprop, ylim=c(0,0.4), xlim=c(0,500), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])
errbar(sums$V1,(forests.guilds.byspp$INGR/sums$spprich) , maxes.byspp$INGRprop, mins.byspp$INGRprop, ylim=c(0,0.4), xlim=c(0,25), col= c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)],pch=c(rep(16,6),15), cex=1.5, errbar.col=c("gray7","black","gray37","gray67")[as.factor(sums$Matrix.type)])

savePlot("3x2 FF INGR by species RP7_70.emf", type="emf")
savePlot("3x2 FF INGR by species RP7_70.eps", type="eps")
savePlot("3x2 FF INGR by species RP7_70.pdf", type="pdf")